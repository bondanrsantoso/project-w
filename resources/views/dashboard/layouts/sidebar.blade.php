        ...
        <div class="sidebar-menu">
            <ul class="menu">
                ...
                <li class="sidebar-item {{ request()->is('dashboard/projects*') ? 'active' : '' }}">
                    <a
                        href="{{ env('APP_DOMAIN_PM', 'http://pm-admin.docu.web.id') }}/dashboard/projects"
                        class='sidebar-link'
                    >
                ...
                <li class="sidebar-item {{ request()->is('dashboard/workgroups*') ? 'active' : '' }}">
                    <a
                        href="{{ env('APP_DOMAIN_PM', 'http://pm-admin.docu.web.id') }}/dashboard/workgroups"
                        class='sidebar-link'
                    >
                ...
                <li class="sidebar-item {{ request()->is('dashboard/jobs*') ? 'active' : '' }}">
                    <a
                        href="{{ env('APP_DOMAIN_PM', 'http://pm-admin.docu.web.id') }}/dashboard/jobs"
                        class='sidebar-link'
                    >
                ...
                <li class="sidebar-item {{ request()->is('dashboard/invoices*') ? 'active' : '' }}">
                    <a
                        href="{{ env('APP_DOMAIN_PM', 'http://pm-admin.docu.web.id') }}/dashboard/invoices"
                        class='sidebar-link'
                    >
                ...
                <li class="sidebar-item {{ request()->is('dashboard/transactions*') ? 'active' : '' }}">
                    <a
                        href="{{ env('APP_DOMAIN_PM', 'http://pm-admin.docu.web.id') }}/dashboard/transactions"
                        class='sidebar-link'
                    >
                ...
                <li class="sidebar-item {{ request()->is('dashboard/workers*') ? 'active' : '' }}">
                    <a
                        href="{{ env('APP_DOMAIN_JOB', 'http://job-admin.docu.web.id') }}/dashboard/workers"
                        class='sidebar-link'
                    >
                ...
                <li class="sidebar-item {{ request()->is('dashboard/companies*') ? 'active' : '' }}">
                    <a
                        href="{{ env('APP_DOMAIN_JOB', 'http://job-admin.docu.web.id') }}/dashboard/companies"
                        class='sidebar-link'
                    >
                ...
                <li class="sidebar-item {{ request()->is('job_applications*') ? 'active' : '' }}">
                    <a
                        href="{{ env('APP_DOMAIN_JOB', 'http://job-admin.docu.web.id') }}/dashboard/job_applications"
                        class='sidebar-link'
                    >
