...
class AuthController extends Controller
{
    public function register(Request $req)
    {
        $valid = $req->validate([
            ...
            'worker.category_id' => "sometimes|required|integer",
            'worker.address' => "sometimes|required|string",
            'worker.place_of_birth' => "sometimes|required|string",
            'worker.date_of_birth' => "sometimes|required|date",
            'worker.gender' => "sometimes|required|string",
            'worker.account_number' => "sometimes|required|string",
            'worker.balance' => "sometimes|nullable|string",
